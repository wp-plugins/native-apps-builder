	...
	class AppsBuilderApi {
		...
		*/
		...
		public function addImage($type,$src){
			...
			return $this->doRequest("/style/addImage",$datas,$files);
		}
		...
		*/
		...
		/*
			...
			titolo,descrizione,keywords,url_support,email_support,category

		*/

		public function setAppInfos($id,$infos = array(),$icon = false ,$splash = false){

			$data=array_merge(array(),$infos);
			...
			if($splash){
				$files["splash_image"] = $splash;
			}

			return $this->doRequest("/app/updateApp/$id",$data,$files);
		...
		*/
		...
		public function addAppleCertificates($id,$key,$pwd,$provision){
			...
			return $this->doRequest("/builder/addAppleCertificates/$id",$datas,$files);
		}
		...
		*/
		...
		private function doRequest($url,$params,$files=false){

			if($files){
				$this->snoopy->submit($this->baseurl.$url,$params,$files);
			}else{
				$this->snoopy->submit($this->baseurl.$url,$params);
			}
