...
if($_POST['appsbuilder_hidden'] == 'Y'){
	...
	<h4>Native Android App Example:</h4><table cellspacing="11"><tr><td style="margin:5px;"><img id="cat_list" size="200" src="'.get_bloginfo('wpurl').'/wp-content/plugins/Native_Apps_Builder/img/categories.png" style="border:none;"> </td><td style="margin:5px;"> <img size="200" src="'.get_bloginfo('wpurl').'/wp-content/plugins/Native_Apps_Builder/img/list_news.png" style="border:none;"></td><td style="margin:5px;"> <img size="200" src="'.get_bloginfo('wpurl').'/wp-content/plugins/Native_Apps_Builder/img/splash_loader.png" style="border:none;"></td></tr><tr style="text-align:center;"><td>Categories List</td><td>Details Category List</td><td>Loading Image Splash Screen</td></tr></table>
		<br /><br />Try Now, it\'s very easy..<br /><br />
	...
	echo     '<strong>Example:</strong> <br /><img src="'.get_bloginfo('wpurl').'/wp-content/plugins/Native_Apps_Builder/img/icon.jpg" style="border:none;">
		 </div>';
