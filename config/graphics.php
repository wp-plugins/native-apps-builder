...
<div class="metabox-holder">
	<div class="postbox">
		...
		<div id="box_right">
			...
			<h4>Preview</h4>
			<div id="cel"><iframe id="appframe" style="top:93px;left:27px;position:relative;" width="283" height="440" src="http://www.apps-builder.com/app/beta/<?php echo $id_app; ?>"></iframe></div>
		</div>
